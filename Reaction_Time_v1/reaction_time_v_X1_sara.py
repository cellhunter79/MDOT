...
#
# 2. Change subject_name, researcher_name if necessary. 
# Use a seperate Excel file to record the subjects information: Name, Gender, Race, Occupancy, etc.) 
# Note: you may need to creat a folder named "results", if it does not exist)
#
...
# Note: If the subject miss a signal, he/she will have a penalty which set the response time to 1 second. No penalty for false positive response.
#
